...
formCadastro.addEventListener('submit', function(event) {
    ...
    const usernmeValue = usernameInput.value.trim();
    const emailValue = emailInput.value.trim();
    const passwordValue = passwordInput.value.trim();

    //verificar se o nome de usuário, email e senha estão preenchidos
    if (usernameInput === '' || emailValue === '' || passwordValue === '') {
